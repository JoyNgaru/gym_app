...
<head>
    ...
    <div id="loginbox">            
            <form id="loginform" class="form-vertical" method="POST" action="#">
				 <!-- <div class="control-group normal_text"> <h3>Kids Login</h3></div> -->
                <div class="control-group">
                    <div class="controls">
                        <div class="main_input_box">
                            <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="text" name="user" placeholder="parentName" />
                        </div>
                    </div>
                </div>
                <div class="control-group">
                ...
                <div class="form-actions">
                  ...
                  <!--remove register button -->
                    <span class="pull-right"><button type="submit" name="login" class="btn btn-success" />Kids Login</button></span>
                </div>
                <div class="g">
                ...
                if (isset($_POST['login']))
                    {
                        ...
                        $query = mysqli_query($con, "SELECT * FROM kids WHERE  password='$password' and parentName='$username' and status='Active'");
                        ...
                        if ($num_row > 0) 
                        ...
                        else
                            {
                                ...
                                Invalid Parentname/Password or Account has been Expired!
            ...
            <form id="recoverform" action="../kids/pages/register-kids.php" method="POST" class="form-vertical">
				<p class="normal_text">Enter your details below and we will send your details for further activation process.</p>
                    ...
                    <br>
                        ...
                        <div class="controls">
                            <div class="main_input_box">
                                <span class="add-on bg_lo"><i class="icon-leaf"></i></span><input type="text" name="parentName" placeholder="@parentName" />
                            </div>
                        </div>
