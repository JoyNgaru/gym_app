...
<?php
    ...
    include "session.php";
    // $id=$_GET['id'];
    $qry= "select * from kids WHERE user_id='".$_SESSION['user_id']."'";
                  ...
                  <tbody>
                    <tr>
                      <td class="msg-invoice" width="55%"> <div class="text-center"><h4>Last Payment Done:  $<?php echo $row['amount']; ?>/-</h4>
                        <em><a href="#" class="tip-bottom" title="Registration Date" style="font-size:15px;"> Kids Member Since: <?php echo $row['dor']; ?> </a></em> </td>
                        </div>
                    </tr>
                  </tbody>
                </table>
