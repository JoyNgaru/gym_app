...
$qry = "insert into kids(fullname,parentName,password,gender,services,amount,plan,address,contact,status) values ('$fullname','$parentName','$password', CURRENT_TIMESTAMP,'$gender','$services','0','$plan','$address','$contact','Pending')";
