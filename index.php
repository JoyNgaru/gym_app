...
<head>
        <title>MMI Gym System</title><meta charset="UTF-8" />
    ...
    <body>
        ...
        <div id="loginbox">            
            ...
            <div class="control-group normal_text"> <h3><img src="img/mmi-icon.ico" alt="Logo" /></h3></div>
            ...
            <break>
            <a href="kids/index.php"><h6>Kids Login</h6></a>
            </div>
            ...
            <a href="parents/index.php"><h6>Parents Login</h6></a>    
