...
>>>>>>> 63f2219c307e6fbd1cd6208f6128099513549272
<meta charset="UTF-8" />
...
<!--sidebar-menu-->
<?php $page='kids-update'; include 'includes/sidebar.php'?>
<!--sidebar-menu-->

<?php
include 'dbcon.php';
$id=$_GET['id'];
$qry= "select * from kids where user_id='$id'";
...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.html" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="#" class="tip-bottom">Manage Kids</a> <a href="#" class="current">Add Kids</a> </div>
<<<<<<< HEAD
  <h1>Update Kid's Details</h1>
=======
  <h1>Update Kids Details</h1>
>>>>>>> 27ae4f30fba143a9671a85623f6b37693dfe429f
</div>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          ...
          <form action="edit-kids-req.php" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="parentName" value='<?php echo $row['parentName']; ?>' />
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <span class="help-block">Note: Only the kids are allowed to change their password until and unless it's an emergency.</span>
              </div>
            </div>
            <div class="control-group">
          ...
          <div class="form-horizontal">
            ...
            <div class="form-actions text-center">
             ...
             <input type="hidden" name="id" value="<?php echo $row['user_id'];?>">
              <button type="submit" class="btn btn-success">Update Kids Details</button>
            </div>
            </form>
