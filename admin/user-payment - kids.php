...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="kids-payment.php">Payments</a> <a href="#" class="current">Invoice</a> </div>
    <h1>Payment Form</h1>
  </div>
            ...
            <div class="row-fluid">
              <div class="span5">
                <table class="">
                  <tbody>
                  <tr>
                      <td><img src="../img/mmi-icon.ico" alt="Gym Logo" width="175"></td>
                    </tr>
                    <tr>
              ...
              <div class="span7">
                <table class="table table-bordered table-invoice">
				  ...
				  <form action="userpay.php" method="POST">
                    <tr>
                    <tr>
                      <td class="width30">Kids Fullname:</td>
                ...
                <select name="plan" required="required" id="select">
                  ...
                  <td class="width30">Kids Status:</td>
                    <td class="width70">
					<div class="controls">
