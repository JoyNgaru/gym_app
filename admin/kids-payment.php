...
<div id="content">
  <div id="content-header">
    ...
    <h1 class="text-center">Registered Kids Payment <i class="fas fa-group"></i></h1>
  </div>
        ...
        $result=mysqli_query($conn,$qry);
          ...
          echo"<table class='table table-bordered data-table table-hover'>
            ...
            <tbody> 
                ...
                <td><div class='text-center'><a href='user-payment - kids.php?id=<?php echo $row['user_id']?>'><button class='btn btn-success btn'><i class='fas fa-dollar-sign'></i> Make Payment</button></a></div></td>
                <td><div class='text-center'><a href='sendReminder - kids.php?id=<?php echo $row['user_id']?>'><button class='btn btn-danger btn' <?php echo($row['reminder'] == 1 ? "disabled" : "")?>>Alert</button></a></div></td>
              </tbody>
          <?php $cnt++; }
