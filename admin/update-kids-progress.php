...
<!--sidebar-menu-->
<?php $page='manage-kids-progress'; include 'includes/sidebar.php'?>
<!--sidebar-menu-->
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="kids-progress.php">Customer Progress</a> <a href="#" class="current">Update Progress</a> </div>
    <h1 class="text-center">Update Kids Progress <i class="fas fa-signal"></i></h1>
  </div>
            ...
            <div class="row-fluid">
              ...
              <div class="span8">
                <table class="table table-bordered table-invoice">
                  ...
                  <tbody>
				  <form action="kids-progress-req.php" method="POST">
                    <tr>
                    <tr>
                      <td class="width30">Kid's Fullname:</td>
