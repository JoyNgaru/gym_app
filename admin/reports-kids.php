...
include "dbcon.php";
$qry="SELECT gender, count(*) as number FROM kids GROUP BY gender";
...
<script type="text/javascript" src="https://www.gstatic.com/charts/loader.js"></script>  
           ...
           {  
                ...
                var options = {  
                      title: 'Percentage of Male and Female GYM Kids Members',  
                      //is3D:true,  
                      pieHole: 0.0 
                     };  
...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="reports-kids.php" class="current">Gender Representation</a> </div>
  ...
  <div id="content-header">
    <h1 class="text-center">Registered Kid's Report <i class="fas fa-chart-bar"></i></h1>
  </div>
  <div class="container-fluid">
