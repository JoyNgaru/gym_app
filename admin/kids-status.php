...
<!--sidebar-menu-->
<?php $page='kids-status'; include 'includes/sidebar.php'?>
<!--sidebar-menu-->

<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="kids-status.php" class="current">Status</a> </div>
    <h1 class="text-center">Kid's Current Status <i class="fas fa-eye"></i></h1>
  </div>
