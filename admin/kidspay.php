...
<!--sidebar-menu-->
<?php $page='kids-payment'; include 'includes/sidebar.php'?>
<!--sidebar-menu-->

<div id="content">
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="kids-payment.php" class="tip-bottom">Payment</a> <a href="#" class="current">Make Payments</a> </div>
  <h1>Payments</h1>
</div>
