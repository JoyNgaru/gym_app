...
$qry="SELECT services, count(*) as number FROM kids GROUP BY services";
$result=mysqli_query($con,$qry);
$qry="SELECT gender, count(*) as enumber FROM kids GROUP BY gender";
$result3=mysqli_query($con,$qry);
      ...
      <div class="widget-box">
        ...
        <div class="widget-content" >
          <div class="row-fluid">
            <div class="span8">
              <!-- <div id="piechart"></div>   -->
              <div id="top_x_div" style="width: 200px; height: 290px;"></div>
            </div>
            <div class="span4">
              <ul class="site-stats">
                <li class="bg_lh"><i class="fas fa-users"></i> <strong><?php include 'dashboard-usercount.php';?></strong> <small>Total Members</small></li>
                <li class="bg_lh"><i class="fas fa-users"></i> <strong><?php include 'dashboard-kidscount.php';?></strong> <small>Total Kids Members</small></li>
                ...
                <li class="bg_lb"><i class="fas fa-calendar-check"></i> <strong><?php include 'actions/count-kids-attendance.php';?></strong> <small>Present Kids</small></li>
              </ul>
            </div>
          </div>
        </div>
