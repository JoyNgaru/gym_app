...
<!--sidebar-menu-->
<?php $page="kids-repo"; include 'includes/sidebar.php'?>
<!--sidebar-menu-->

<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="kids-report.php" class="current">Kids Reports</a> </div>
    <h1 class="text-center">Kids's Report <i class="fas fa-file"></i></h1>
  </div>
  <div class="container-fluid print-container">
    <div class="row-fluid">
     ...
     <div class="widget-content">
              ...
              <div class="span4">
                <table class="">
                  <tbody>
                    ...
                    <tr>
                      <td>Tel: +254 722865902</td>
                    </tr>
                    <tr>
                      <td >Email: info@mmi.co.ke</td>
                    </tr>
                  </tbody>
                </table>
              </div>
            ...
            <div class="row-fluid">
                <div class="pull-left">
                <h4>Kids <?php echo $row['fullname']; ?>,<br/> <br/> Membership is currently <?php echo $row['status']; ?>! <br/></h4><p>Thank you for choosing our services.<br/>- on the behalf of whole team</p>
                </div>
