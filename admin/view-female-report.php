...
<!--sidebar-menu-->
<?php $page="female-repo"; include 'includes/sidebar.php'?>
<!--sidebar-menu-->

<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="female-report.php" class="current">Female Reports</a> </div>
    <h1 class="text-center">Female Report <i class="fas fa-file"></i></h1>
  </div>
  <div class="container-fluid print-container">
    <div class="row-fluid">
     ...
     <div class="widget-content">
            ...
            <div class="row-fluid">
                <div class="pull-left">
                <h4>Member <?php echo $row['fullname']; ?>,<br/> <br/> Membership is currently <?php echo $row['status']; ?>! <br/></h4><p>Thank you for choosing our services.<br/>- on the behalf of MMI team</p>
                </div>
