...
<div id="content-header">
  <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="#" class="tip-bottom">Manage Academy</a> <a href="#" class="current">Add Kids</a> </div>
  <h1>Kids Entry Form</h1>
    ...
    <div class="span6">
      <div class="widget-box">
        ...
        <div class="widget-content nopadding">
          <form action="add-kids-req.php" method="POST" class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span11" name="username" placeholder="ParentName" />
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <input type="password"  class="span11" name="password" placeholder="parentNumber"  />
        ...
        <div class="widget-content nopadding">
          <div class="form-horizontal">
            ...
            <div class="control-group">
              ...
              <div class="controls">
                ...
                <label>
                  ...
                  <input type="radio" value="Sauna" name="services" />
                  Dance Classes <small>- $50 per month</small></label>
            ...
            <div class="form-actions text-center">
              ...
              <button type="submit" class="btn btn-success">Submit Kids Details</button>
