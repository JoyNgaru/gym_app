...
<!--sidebar-menu-->
<?php $page="male-repo"; include 'includes/sidebar.php'?>
<!--sidebar-menu-->

<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="index.php" title="Go to Home" class="tip-bottom"><i class="fas fa-home"></i> Home</a> <a href="male-report.php" class="current">Male Reports</a> </div>
    <h1 class="text-center"> Male Report <i class="fas fa-file"></i></h1>
  </div>
