...
$qry = "INSERT INTO members (fullname, username, password, gender, services, plan, address, contact, status) VALUES ('$fullname', '$username', '$password', '$gender', '$services', '$plan', '$address', '$contact', 'Pending')";
